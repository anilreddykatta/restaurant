			...
			compile: function uiMaskCompilingFunction () {
				...
				return function uiMaskLinkingFunction ( scope, iElement, iAttrs, controller ) {
					...
					function eventHandler ( e ) {
						...
						// Handles cases where caret is moved and placed in front of invalid maskCaretMap position.
						// Logic below ensures that, on click or leftward caret placement, caret is moved leftward
						// until directly right of non-mask character. Also applied to click since users are (arguably)
						// more likely to backspace a character when clicking within a filled input.
						...
						// Ensure that typing always places caret ahead of typed character in cases where the first
						// char of the input is a mask char and the caret is placed at the 0 position.
						...
						// Scoot the caret back or forth until it's in a non-mask position and within min/max position
						// limits
